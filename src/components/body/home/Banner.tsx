...
const Banner = () => {
  return (
    <div className="w-screen h-screen px-4 md:px-10 lg:px-20 flex justify-center flex-col  text-white" style={{background: "url('/slide-02.jpg')", backgroundSize: "100% 100%",backgroundRepeat: "no-repeat"}}>
